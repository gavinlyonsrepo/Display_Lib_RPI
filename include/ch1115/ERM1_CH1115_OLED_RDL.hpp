...
class ERMCH1115 : public bicolor_graphics   {
	...
	private:
		...
		{
			static constexpr uint16_t INITDELAY =  100;   /**< Init delay mS */
			static constexpr uint16_t RST_DELAY1 = 10;    /**< Reset Delay in mS*/
			static constexpr uint16_t RST_DELAY2 = 100;   /**< Reset Delay 2 in mS */
		};
		...
		uint16_t _OLEDHighFreqDelay = 0; /**< uS GPIO Communications delay, SW SPI ONLY */
