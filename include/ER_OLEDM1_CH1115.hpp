 /*!
	...
	Project Name: ER_OLEDM1_CH1115 , URL: https://github.com/gavinlyonsrepo/ER_OLEDM1_CH1115_RPI
	@author  Gavin Lyons
*/
...
class ERMCH1115 : public ERMCH1115_graphics  {
  ...
  public:
	...
	bool OLEDbegin(uint8_t contrast = ERMCH115_CONTRAST_DATA_DEFAULT, uint32_t SPICLK_DIVIDER  = 0, uint8_t SPICE_Pin = 0 );
	void OLEDinit(void);
	void OLEDReset(void);
  ...
  private:
	...
	const uint16_t _LibVersionNum = 133; /**< library version number 133 1.3.3*/
