...
| bitmap_test | Shows use of bitmaps methods |
| text_graphics_functions_tests | Fonts graphics + misc functions |
| framerate_test | Frames per second test, hardware or software SPI |
