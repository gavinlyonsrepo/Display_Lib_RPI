...
These offsets can be used in the event of screen damage or manufacturing errors around edge such as cropped data or defective pixels.
...
In example folder: the main.cpp files contain tests showing library functions.
