/*!
	@file examples/ht16k33/test_7_segment/main.cpp
...
void TestChar(void)
{
	std::cout <<  "Test single character 123" << std::endl;
	myHT.ClearDigits(); //Clear display
	delayMilliSecRDL(DISPLAY_DELAY_1);
	...
	std::cout <<  "Test single character with dec point on, 4.5.6." << std::endl;
