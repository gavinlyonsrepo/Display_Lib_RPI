/*!
	@file examples/color16_displays/st7735/Text_Graphics_Functions/main.cpp
...
void Test703(void) {
	std::cout << "Test 703: Print entire ASCII font 0 to 254, default font" << std::endl;
	uint8_t row = 5;
	uint8_t col = 5;
	myTFT.setTextColor(RDLC_GREEN, RDLC_BLACK);
