/*!
	@file examples/bicolor_displays/sh1106/BITMAP/main.cpp
	@author Gavin Lyons
	@brief Test file for SH1106_OLED library, showing how to draw bitmaps, 128X64 screen
...
SH110X_RDL myOLED(myOLEDwidth ,myOLEDheight) ; // instantiate  an object
