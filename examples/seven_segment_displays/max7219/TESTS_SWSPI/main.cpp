/*!
	@file examples/seven_segment_displays/max7219/TESTS_SWSPI/main.cpp
	@author Gavin Lyons
...
#define  CLK 22  // clock GPIO, connected to clock line of module
#define   CS 24   // Chip Select GPIO, connected to CS line of module
#define  DIN 27  // data in GPIO, connected to DIN line of module
