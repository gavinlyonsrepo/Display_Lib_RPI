...
uint16_t MY_TFT_WIDTH = 240;// Screen width in pixels
uint16_t MY_TFT_HEIGHT = 280; // Screen height in pixels
...
// ** USER OPTION 3 SPI**
	if(myTFT.TFTInitSPI(HWSPI_DEVICE, HWSPI_CHANNEL, HWSPI_SPEED, HWSPI_FLAGS, GPIO_CHIP_DEV) != rdlib::Success)
	{
		return 3;
	}
//*****************************
