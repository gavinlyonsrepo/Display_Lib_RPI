/*! 
	...
	@brief Hello World hardware SPI test , 120x160 ST7735S Black Tab 
	@author Gavin Lyons.
	@note See USER OPTIONS 1-3 in SETUP function
	@test 
		-# 103 Hello World, Hardware SPI, 120x160 ST7735S Black Tab 
*/
...
// ** USER OPTION 3 PCB_TYPE + SPI settings**
	...
	if(myTFT.TFTInitPCBType(myTFT.TFT_ST7735S_Black, SPI_DEV, SPI_CHANNEL, SPI_SPEED, SPI_FLAGS, GPIO_CHIP_DEV) != rdlib::Success)
	{
		return 3;
	}
//*****************************
