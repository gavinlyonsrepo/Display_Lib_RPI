/*!
	@file   GC9107_TFT_LCD_RDL.cpp
	@author Gavin Lyons
	@brief  Source file for GC9107 TFT LCD library. Contains driver methods.
			Project Name: Display_Lib_RPI
*/

#include "../../include/gc9107/GC9107_TFT_LCD_RDL.hpp"
...
/*!
	...
	@return
		...
		-# upstream failure from TFTGC9107Initialize()
	@note overloaded 2 off, 1 for HW SPI , 1 for SW SPI
*/
rdlib::Return_Codes_e GC9107_TFT::TFTInitSPI(int device, int channel, int speed, int flags, int gpioDev)
{
...
/*!
	...
	@note overloaded 2 off, 1 for HW SPI , 1 for SW SPI
*/
rdlib::Return_Codes_e GC9107_TFT::TFTInitSPI(uint16_t CommDelay, int gpioDev)
{
...
*/
rdlib::Return_Codes_e  GC9107_TFT::TFTPowerDown(void)
{
...
/*!
	...
	@return a rdlib::Return_Codes_e  code
		...
		-# rdlib::GpioPinClaim
*/
rdlib::Return_Codes_e GC9107_TFT::TFTResetPin() {
	if (_resetPinOn == true){
...
/*!
	...
	@return a rdlib::Return_Codes_e  code
		...
		-# rdlib::GpioPinClaim
*/
rdlib::Return_Codes_e GC9107_TFT::TFTDataCommandPin(void) {
...
/*!
	...
	@return a rdlib::Return_Codes_e  code
		...
		-# rdlib::GpioPinClaim
*/
rdlib::Return_Codes_e GC9107_TFT::TFTClock_Data_ChipSelect_Pins(void)
{
...
/*!
	...
	@note overloaded 2 off, 1 for HW SPI , 1 for SW SPI
*/
void GC9107_TFT::TFTSetupGPIO(int8_t rst, int8_t dc)
{
	_hardwareSPI = true;
	TFTSetupResetPin(rst);
	_Display_DC = dc;
...
*/
rdlib::Return_Codes_e GC9107_TFT::TFTGC9107Initialize() {
...
*/
uint16_t GC9107_TFT::HighFreqDelayGet(void){return _HighFreqDelay;}

/*!
	@brief Freq delay used in SW SPI setter, uS delay used in SW SPI method
	@param CommDelay The GPIO communications delay in uS
*/
void  GC9107_TFT::HighFreqDelaySet(uint16_t CommDelay){_HighFreqDelay = CommDelay;}
...
*/
void GC9107_TFT::TFTcmdInitSequence(void)
{
...
*/
void GC9107_TFT::TFTSetupResetPin(int8_t rst)
{
	if(rst != -1)
	{
		_Display_RST= rst;
