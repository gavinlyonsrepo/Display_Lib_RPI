...
#include "../../include/font_data_RDL.hpp"
...
/*!
	...
	@return	Will return rpiDisplay_Return_Codes_e  enum
		-# Pass rpiDisplay_Success
		-# Error 1 rpiDisplay_WrongFont
		-# Error 2 rpiDisplay_FontPtrNullptr
 */
rpiDisplay_Return_Codes_e display_Fonts::setFont(display_Font_name_e FontChoice) {
	...
	if (SelectedFontName == nullptr)
	{
		...
		return rpiDisplay_FontPtrNullptr;
	}
