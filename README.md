...
* Development Tool chain.
	...
	5. bcm2835 Library v1.74 dependency. Provides low level I2C bus, delays and GPIO control.
...
```sh
curl -sL https://github.com/gavinlyonsrepo/Display_Lib_RPI/archive/1.0.1.tar.gz | tar xz
```
...
6. Run 'make' commmand. This builds the examples file using the just installed library,
		and creates a test executable file in "Bin".
7. Run 'make run' to run that built executable file. This wraps "sudo" as the bcm2835 requires root permissions by default [see here for details](http://www.airspayce.com/mikem/bcm2835/)
...
[The application programming interface documentation](https://gavinlyonsrepo.github.io/misc/software_docs/Display_Lib_RPI/index.html) 
is at link hosted on github pages and generated by Doxygen.
